...
#define SSID  "Quang Cao Thuan Thanh"      // change this to match your WiFi SSID
#define PASS  "longthanh"  // change this to match your WiFi password
#define PORT  "8080"        // using port 8080 by default

// If using Software Serial for debug, use the definitions below
#include <SoftwareSerial.h>
SoftwareSerial dbg(6,5);  // use pins 2,3 for software serial 
#define esp Serial
