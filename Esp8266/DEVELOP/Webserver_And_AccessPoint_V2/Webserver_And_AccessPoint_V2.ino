...
{
  // Check if there are any GET parameters
  if (server.hasArg("gpio4"))
  { 
    if (server.arg("gpio4") == "1")
    {
  ...
  response_message += "GPIO4:<br>";

  if (digitalRead(GPIO4) == LOW)
  {
    response_message += "<input type=\"radio\" name=\"gpio4\" value=\"1\" onclick=\"submit();\">On<br>";
    response_message += "<input type=\"radio\" name=\"gpio4\" value=\"0\" onclick=\"submit();\" checked>Off<br>";
  }
  else
  {
    response_message += "<input type=\"radio\" name=\"gpio4\" value=\"1\" onclick=\"submit();\" checked>On<br>";
    response_message += "<input type=\"radio\" name=\"gpio4\" value=\"0\" onclick=\"submit();\">Off<br>";
  }
