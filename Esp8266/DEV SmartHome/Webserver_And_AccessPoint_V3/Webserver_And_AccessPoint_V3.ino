...
String JScriptSuLyChung()
{
    String JVScript = "<script type='application/javascript'> var internetIP = \"\";\
...
{
  int x = rand() % 130;
  String HTML = String(x) +  "<div align=center>\
...
void Desktop() 
{
  ...
  int SoTu = strlen(HTMLs);
  char temp[SoTu];     
  snprintf ( temp, SoTu, HTMLs  );
