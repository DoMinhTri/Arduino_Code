...
void CallResetDefault(){ if (server.hasArg("resetdefault")){ String  sStas = server.arg("resetdefault").c_str();  uint8_t nStas = sStas.toInt();  if( nStas == 1){ ResetDefault(); Reset(); }}}
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
/////////////////////      EEPROM      ///////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
...
String JScriptFunctions()
{
    String JVScript = "<script>\
                     ...
                     function SpeedUD(_value){ var Speed = parseInt(document.getElementById('Speed').value); if(_value== 1) { if( Speed  < 100) { Speed += 5; } } if(_value!= 1) { if( Speed  > 5 )  { Speed -= 5; } } document.getElementById('Speed').value = Speed ; TankGo(); }\
                     function ChonHuong(_huong){ Huong = _huong; TankGo(); }\
                     function TankGo(){ var _speed = document.getElementById('Speed').value; var url = '/?huong=' + Huong + '&speed=' + _speed ; SendURL(url);}\
                     </script>";
  return JVScript;
}
//////////////////////////////////////////////////////////////////////////////////
String JScriptPrivate()
{
    String JVScript = "<script>\
                      ...
                      function DReset(){ SendURL('/setting?resetdefault=1'); }\
...
String GiaoDienNutBam()
{
  String HTML ="<div align=center>\
                <table border='0' width='100%' cellspacing='0' cellpadding='0'>\
                  <tr>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='\\'      onclick='ChonHuong(8)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='&#9650;' onclick='ChonHuong(1)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='/'       onclick='ChonHuong(2)'></td>\
                    <td width='100%'>&nbsp;</td>\
                    <td width='24' ><input type='button' class='myButton' value='&#9650;' onclick='SpeedUD(1)' style='width:250px'></td>\
                  </tr>\
                  <tr>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='&#9668;' onclick='ChonHuong(7)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='&#9632;' onclick='ChonHuong(9)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='&#9658;' onclick='ChonHuong(3)'></td>\
                    <td width='100%'>&nbsp;</td>\
                    <td width='24'><select size='1' id='Speed' class='myButton' style='width:250px'><option value='5' selected>5</option><option value='10'>10</option><option value='15'>15</option><option value='20'>20</option><option value='25'>25</option><option value='30'>30</option><option value='35'>35</option><option value='40'>40</option><option value='45'>45</option><option value='50'>50</option><option value='55'>55</option><option value='60'>60</option><option value='65'>65</option><option value='70'>70</option><option value='75'>75</option><option value='80'>80</option><option value='85'>85</option><option value='90'>90</option><option value='95'>95</option><option value='100%'>100</option></select></td>\   
                  </tr>\
                  <tr>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='/'       onclick='ChonHuong(6)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='&#9660;' onclick='ChonHuong(5)'></td>\
                    <td width='27'><input type='button' class='myButton myBTFit' value='\\'      onclick='ChonHuong(4)'></td>\
                    <td width='100%'>&nbsp;</td>\
                    <td width='24'><input type='button' class='myButton' value='&#9660;' onclick='SpeedUD(0)' style='width:250px'></td>\
                  </tr>\
                </table>\
              </div>";
  return HTML;
...
void Setting()
{
  ...
  String HTML  = Header + JScriptFunctions() + JScriptPrivate() + JScriptAdmin()+ CStyleCSS();
         ...
         HTML += "<input type='button' value=' Reset default' class='myButton'  onclick='DReset()'>"; 
...
void loop() 
{
   ...
   if(ChuoiDuLieu != "")
   {
      if(ChuoiDuLieu == "RESET_DEFAULT"){ Serial.println("RESET DEFAULT"); ResetDefault();  Reset(); }
