...
char* JScriptSuLyChung()
{
    char* JVScript = "<script type='application/javascript'> var internetIP = \"\";\
                     ...
                     function TankGo(){  var url = '/?huong=' + Huong  ; SendURL(url);}\
                     function SendA(){ SendURL('http://192.168.13.104/uptosmart?UTS_DATA=UTSA'); }\
                     function SendB(){ SendURL('http://192.168.13.104/uptosmart?UTS_DATA=UTSB'); }\
                     function SendC(){ SendURL('http://192.168.13.104/uptosmart?UTS_DATA=UTSC'); }\
  ...
  String HTML ="<div align=center>\
                <table border='0' width='100%' cellspacing='0' cellpadding='0'>\
                  <tr>\
                    ...
                    <td width='100%'>&nbsp;</td>\
                    <td width='24' ><input type='button' class='myButton' value='On' onclick='SendA()' style='width:250px'></td>\
                  </tr>\
                  <tr>\
                    ...
                    <td width='100%'>&nbsp;</td>\
                    <td width='24' ><input type='button' class='myButton' value='Off' onclick='SendB()' style='width:250px'></td>\
                  </tr>\
                  <tr>\
                    ...
                    <td width='100%'>&nbsp;</td>\
                    <td width='24' ><input type='button' class='myButton' value='Relay' onclick='SendC()' style='width:250px'></td>\
                  </tr>\
                </table>\
              </div>";
  return HTML;
...
{
/*
  char* HTML  = Header + JScriptSuLyChung() + CStyleCSS();
         HTML += TieuDe("Login");
         HTML += "<text class='text shadow' style='color:red'> Name </text><br>";
...
void SuLyGiaTriChuoiNhan(String ChuoiNhan)
{
  ...
  if(ChuoiNhanDang == "UTS_RSTART")  { Serial.println("RESTART");  Restart(); }
