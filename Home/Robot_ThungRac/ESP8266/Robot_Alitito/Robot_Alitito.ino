...
void Xe_Toi()  { Serial.print("#BOT+u1"); }
void Xe_Ngung(){ Serial.print("#BOT+s");  }
void Xe_Lui()  { Serial.print("#BOT+d1"); }
void Xe_Trai() { Serial.print("#BOT+t1"); }
void Xe_Phai() { Serial.print("#BOT+p1"); }
/////////////////////////////////////////////////////////////////////////////
void DongCoA_Lui()
{
