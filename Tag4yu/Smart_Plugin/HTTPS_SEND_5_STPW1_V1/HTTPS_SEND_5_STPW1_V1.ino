// 0xE5,0x2E,0x56,0x9D,0x01,0xB0,0x88,0xF9,0x12,0x63,0x4E,0xD8,0x32,0x51,0xA9,0xBC,0x32,0x4C,0x0C,0x0E   // fingerprint : https/nfc2cloud.com/ssl.php (MD5)
...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
void CheckPage(){  server.send(200, "text/html", myOnIP ); }
//////////////////////////////////////////////////////////////////////////////////
void LedControl()
{  
   String tagleds = ""; 
   ...
   server.send(200, "text/html", (String)LedStas ); 
}
//////////////////////////////////////////////////////////////////////////////////
String tagssid = "";
String tagpass = "";
void InputPage()
{
  ...
  if((tagssid != "") && (tagpass != ""))
  {
    if(mySSID != tagssid){ Restart(); }
    if(myPASS != tagpass){ Restart(); }
  }
  ////////////////////////
  server.send(200, "text/html", mySSID);
}
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
...
void setup() 
{
  ...
  server.on("/check", CheckPage);
  server.on("/ledct", LedControl);
