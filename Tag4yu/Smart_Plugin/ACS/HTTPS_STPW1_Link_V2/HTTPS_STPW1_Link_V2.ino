//  0xE5,0x2E,0x56,0x9D,0x01,0xB0,0x88,0xF9,0x12,0x63,0x4E,0xD8,0x32,0x51,0xA9,0xBC,0x32,0x4C,0x0C,0x0E   // fingerprint : https/nfc2cloud.com/ssl.php
...
void loop() {
  ...
  server.handleClient();
  sUrl = "https://nfc2cloud.com/iot/spwl/?iddv=" + myMac ;
  ///////////////////////
  ...
  if( WiFiMulti.run() == WL_CONNECTED ) 
  {
       ...
       uint8_t Denled = GetHTTPSData(sUrl).toInt();
...
void TinhThoiGianReset()
{
  ...
  if( cGio > 7){ if(LedStas == 2){ Restart(); }}
}
//////////////////////////////////////////////////////////////////////////////////
