...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
void LedOn() {  digitalWrite(GPIO2, LOW);   Serial.println("Led on");  }
void LedOff(){  digitalWrite(GPIO2, HIGH);  Serial.println("Led off"); }
...
const char *wi_ssid  = "Tag4yu";    // Wifi 
...
void setup() 
{
  ...
  IPAddress wip     = IPAddress(192,168,1,123);
...
String LayChuoiJson()
{
        HTTPClient http;
        String payload = "";
        String SVLink  = "http://conekduca.com/smartplugin/?ID=ABC" ;//+ SVID ;
