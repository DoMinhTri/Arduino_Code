...
void setup() 
{
   ...
   //m24sr._cmds = true;
   m24sr._setup();
   Serial.println("");  Serial.print("RAM: ");
//   displayFreeRAM();
   Serial.print("-------  SystemFile  -------"); Serial.print("");
   m24sr.displaySystemFile();
   ///////////////////////////////
   NdefMessage* pNDefMsg = m24sr.getNdefMessage();
    if (pNDefMsg != NULL) {
       Serial.println(""); Serial.print("-------  NdefMessage  -------"); Serial.print("");
       pNDefMsg->print();
       Serial.println("");  Serial.print("-------  Record  -------"); Serial.println("");
       NdefRecord rec = pNDefMsg->getRecord(0);
       Serial.print("NDefRecord: "); rec.print();
    }
}
