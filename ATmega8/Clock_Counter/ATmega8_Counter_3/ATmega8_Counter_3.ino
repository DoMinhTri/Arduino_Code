...
void setup() { 
    ...
    DongRelay();
    ///////////////    
    pinMode(A1, INPUT_PULLUP); // HOUR
    pinMode(A2, INPUT_PULLUP); // MINUTE
    pinMode(A3, INPUT_PULLUP); // STATE
    Gio  = EEPROM.read(0);
    Phut = EEPROM.read(1);
    TThai = 0;
    TGBD = millis()/1000;
...
///////////////////////////////////////////////////////////
void DongRelay(){ digitalWrite(2,HIGH); }
void MoRelay(){ digitalWrite(2,LOW); }
///////////////////////////////////////////////////////////
