...
/////////////////////  Wifi 
String WifiName, WifiPass, WifiIP, WifiPort, SVID, DVNUM;
...
void LayChiSoManHinh(String UartDataX)
{
    ...
    {
      if(UartDataX == TenManHinh[i]) ChiSoManHinh = i;
    }
}
//////////////////////////////////////////////////////////////////////////////////
uint8_t LayWifiNamePass = 0;
void HMIDataCheck(String ChuoiData)
{
    ...
    switch (ChiSoManHinh) {
    case 1:
          if(ChuoiData == "pWSEARCH") { WifiSearch = true; }
          //if(LayWifiNamePass==1){ WifiName = ChuoiData.substring(1, ChuoiData.length());  LayWifiNamePass = 0; HMISendTxT("t0", WifiName); }
          //if(LayWifiNamePass==2){ WifiPass = ChuoiData.substring(1, ChuoiData.length());  LayWifiNamePass = 0; HMISendTxT("t1", WifiPass); }
          //if(ChuoiData == "pWN") LayWifiNamePass = 1;
          //if(ChuoiData == "pPW") LayWifiNamePass = 2;
      break;
    case 2:
          Serial.print("B");
      break;
    default:
          if(ChuoiData == "pN1") { MangTTDen[0] = (MangTTDen[0] + 1)%2; DeviceUpdate = 1; }
          if(ChuoiData == "pN2") { MangTTDen[1] = (MangTTDen[1] + 1)%2; DeviceUpdate = 1; }
          if(ChuoiData == "pN3") { MangTTDen[2] = (MangTTDen[2] + 1)%2; DeviceUpdate = 1; }
          if(ChuoiData == "pN4") { MangTTDen[3] = (MangTTDen[3] + 1)%2; DeviceUpdate = 1; }
    break;
  }
}
//////////////////////////////////////////////////////////////////////////////////
    ...
    case 1:
          if(WifiSearch)
          {
              ...
              if(ap_count >0)
              {
                  ...
                  WifiSearch = false;
                  HMISendOpjectInt("tTimerSearch.en", 0 );
              }
          }
      break;
    case 2:
