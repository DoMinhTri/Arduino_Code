...
void loop() 
{
   digitalWrite(0, HIGH);  digitalWrite(2, HIGH); delay(1000);
   digitalWrite(0, LOW);   digitalWrite(2, HIGH); delay(1000);
   
   server.handleClient();
   ////////////////////////////
   Serial.println("11"); delay(500);Serial.println("10"); delay(500);
   Serial.println("21"); delay(500);Serial.println("20"); delay(500);
   Serial.println("31"); delay(500);Serial.println("30"); delay(500);
   //Serial.println("41"); delay(500);Serial.println("40"); delay(500);
   ////////////////////////////
