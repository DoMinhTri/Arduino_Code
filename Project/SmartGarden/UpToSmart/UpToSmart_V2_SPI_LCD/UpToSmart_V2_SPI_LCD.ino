...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
void ShowThongTinMoiTruong_Old()
{
    DataSensor  = "UTS_MCU:\"{Name}\",UpToSmart.VN_" + (String)Relay[0]   + "," + (String)Relay[1] + "," + (String)Relay[2] + "," + (String)Relay[3] + "_" +  nNhietDo           + "_";
    DataSensor += ChuSo2DonVi(DoAmDat[0]) + "," + ChuSo2DonVi(DoAmDat[1]) + "," + ChuSo2DonVi(DoAmDat[2])  + "_" + ChuSo2DonVi(DoAmMua)   + "," + (String)nThoiTiet   + ","  + (String)TroiMua + "_"  + ChuSo2DonVi(nLanTuoi) + "_";               
...
{
    DataSensor  = "UTS_MCU:UpToSmart.VN_" + (String)Relay[0]   + "," + (String)Relay[1] + "," + (String)Relay[2] + "," + (String)Relay[3] + "_" +  nNhietDo           + "_";
    DataSensor += ChuSo2DonVi(DoAmDat[0]) + "," + ChuSo2DonVi(DoAmDat[1]) + "," + ChuSo2DonVi(DoAmDat[2])  + "_" + ChuSo2DonVi(DoAmMua)   + "," + (String)nThoiTiet   + ","  + (String)TroiMua + "_"  + ChuSo2DonVi(nLanTuoi) + "_";               
    DataSensor += ChuSo2DonVi(ngay) + "/" + ChuSo2DonVi(thang) + "/" + ChuSo2DonVi(nam) + "/" + ChuSo2DonVi(gio) + "/" + ChuSo2DonVi(phut)+ "/" + ChuSo2DonVi(giay) ;     
    Serial.println(DataSensor);
    DataSensor  = "";
