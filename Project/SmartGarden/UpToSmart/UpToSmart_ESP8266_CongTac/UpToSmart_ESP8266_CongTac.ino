...
void LoadThongTinCaiDat()
{
  ...
  if(LoadEEPROM(0) > 0)
  {
      WifiName   = "Chua Long An"; 
      WifiPass   = "muongihoithaykia";
      WifiIP     = "";
      WifiPort   = "80"; 
      /////////////////////////////
...
{
  //Chuoi =  "{TrangThaiCT:\"a,b,c,d\"}";

  String  aa = Chuoi.substring(14, 15);
  String  bb = Chuoi.substring(16, 17);
  String  cc = Chuoi.substring(18, 19);
  String  dd = Chuoi.substring(20, 21);
   ...
   if(KetNoiLanDau)
   {
        ...
        if(httpCode > 0) 
        {
            if(httpCode == HTTP_CODE_OK) 
            {
                ...
                //if(payload != ""){ SuLyCongTac(payload); } // Sử lý chuổi nhần từ server
            }
        } 
        http.end();
    }
