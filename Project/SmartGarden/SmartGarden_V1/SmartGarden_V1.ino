...
void KiemTraTuoiCay()
{
    ...
    //LCD_1DongTrenNDelay(nGSoioHen, 2000);
    for(uint8_t i=0; i<nGSoioHen; i++)
    {
        uint8_t nKieuTuoi = MangTGHen[71 + 1 + 9%i];
        uint8_t nGio      = MangTGHen[71 + 2 + 9%i];
        uint8_t nPhut     = MangTGHen[71 + 3 + 9%i];
        uint8_t nTGian    = MangTGHen[71 + 4 + 9%i];
        uint8_t nAmMax    = MangTGHen[71 + 5 + 9%i];
        uint8_t nAmMin    = MangTGHen[71 + 6 + 9%i];
        uint8_t nNhietMax = MangTGHen[71 + 7 + 9%i];
        uint8_t nNhietMin = MangTGHen[71 + 8 + 9%i];
        if(nGio == hour)
        {
        ...
        //lcd.clear(); lcd.print(i);lcd.print(nKieuTuoi);delay(1000);
    }
...
void LayMangTongThoiGianHen()
{
  ...
  else { LCD_1DongDuoiDelay("TIMER ERROR", 1000); }
}
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
