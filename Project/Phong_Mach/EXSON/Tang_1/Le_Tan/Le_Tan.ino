...
void SuLyTinHieu()
{
    ...
    ChuongReo();
    lcd.print(char3); lcd.print(char4);lcd.print(char5);lcd.print(char6);lcd.print(char7);lcd.print("-");
    CoTinHieu = false;
}
/////////////////////////////////////////////////////////////////////////////////////////
...
void KiemTraTinHieuNhan()
{
  ...
  {
      if( PhongNhan == (int)Phong){  CoTinHieu = true; }
  }
  ///////////
}
