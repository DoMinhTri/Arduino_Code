...
/////////////////////////////////////////////////////////////////////////////////////////
void SuLyPhanHoi(char BNut)
{
    if(BNut == 'S') { MangTinHieu[0] = 0; SendGiaTri(MangTinHieuD[0]); if(SoTinHieu >0) SoTinHieu--; }
    if(BNut == 'K') { MangTinHieu[1] = 0; SendGiaTri(MangTinHieuD[1]); if(SoTinHieu >0) SoTinHieu--; }
    lcd.setCursor(11, 0);
    lcd.print("Total");
    lcd.setCursor(13, 1);
    lcd.print(SoTinHieu);
