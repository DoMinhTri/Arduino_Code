...
void loop(void) 
{
  NhanTinHieu();
  GuiTinHieu();
  if(digitalRead(NutBam) == LOW) { SendGiaTri("Phong_Y3"); }
  //if(digitalRead(NutTat) == LOW) SendGiaTri("Phong_N2");
}
/////////////////////////////////////////////////////////////////////////////////////////
void SuLyTinHieu(String Chuoi)
{
    if(Chuoi == "Phong_K3") { digitalWrite(DenLed, LOW);  Serial.print(Chuoi); } // Ok nhan tin hieu
    if(Chuoi == "Phong_D3") { digitalWrite(DenLed, HIGH); Serial.print(Chuoi); } // Complete tin hieu
}

