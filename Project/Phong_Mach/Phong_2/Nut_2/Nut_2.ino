...
void loop(void) 
{
  NhanTinHieu();
  GuiTinHieu();
  if(digitalRead(NutBam) == LOW) SendGiaTri("Phong_Y2");
  //if(digitalRead(NutTat) == LOW) SendGiaTri("Phong_N2");
}
/////////////////////////////////////////////////////////////////////////////////////////
void SuLyTinHieu(String Chuoi)
{
    if(Chuoi == "Phong_K2") { digitalWrite(DenLed, LOW);  Serial.print(Chuoi); } // Ok nhan tin hieu
    if(Chuoi == "Phong_D2") { digitalWrite(DenLed, HIGH); Serial.print(Chuoi); } // Complete tin hieu
}

