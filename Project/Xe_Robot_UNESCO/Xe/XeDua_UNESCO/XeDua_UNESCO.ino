...
{
  Serial.println("----------------");
  uint8_t KCVatCan = TinhKhoangCach();
  uint8_t ToaDoY   = KCVatCan/KHChuan;
  Servo_Duoi.write(180);
  
  delay(1000);
  KCVatCan = TinhKhoangCach();
  uint8_t ToaDoX   = KCVatCan/KHChuan;
  Servo_Duoi.write(90);
  
  delay(1000);
  Serial.print(ToaDoX); Serial.print(" - ");  Serial.print(ToaDoY); Serial.println("");
}
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
int LaySoDuong(int So){  if(So <0 ) So = -So;  return So; }
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////   Đo khoảng cách   ////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
